...
//! every receiver. Since the ownership of the data is transfered, the data is cloned for each
//! receiver and hence [`Clone`] trait is required on the type of the data being transmitted.
//!
//! ### Examples
//!
//! ```
